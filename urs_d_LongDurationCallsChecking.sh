...
# Version : 1.1
#
# Description : Long Duration Call Case Checking
#
#----------------------------------------------------------
# Revision History:
...
BETWEEN_DIR=/home/urpadm/job1-2/betweens #temp for between cases
POSSIBLE_SUCCESS=/home/urpadm/job1-2/possible_success #temp for possible success
